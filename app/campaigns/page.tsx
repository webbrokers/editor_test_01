...
import { Plus, Calendar, MoreVertical, Play, Pause, Trash2 } from 'lucide-react';
    ...
    return (
        <div className="p-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold mb-2">Рекламные кампании</h1>
                    <p className="text-foreground/60">Управляйте вашими кампаниями программы лояльности</p>
                </div>
                <Link
                    href="/campaigns/new"
            ...
            {campaigns.length === 0 ? (
                <div className="glass rounded-2xl p-16 text-center">
                    ...
                    <h3 className="text-xl font-bold mb-2">Нет кампаний</h3>
                    <p className="text-foreground/60 mb-6">Создайте свою первую кампанию, чтобы начать работу</p>
                    <Link
                        href="/campaigns/new"
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-6 text-sm text-foreground/60">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span>Создана: {new Date(campaign.createdAt).toLocaleDateString('ru-RU')}</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span>Нод: {campaign.nodes?.length || 0}</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span>Обновлена: {new Date(campaign.updatedAt).toLocaleDateString('ru-RU')}</span>
                                        </div>
                                    </div>
                                </div>
